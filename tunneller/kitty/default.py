...
SSHManualHostKeys\\
SUPDUPLocation\The%20Internet\
SUPDUPCharset\0\
SUPDUPMoreProcessing\0\
SUPDUPScrolling\0\
ProxySelection\-%20Session%20defined%20proxy%20-\
ScriptFileName\\
ScriptMode\0\
ScriptLineDelay\0\
ScriptCharDelay\0\
...
HyperlinkRegularExpression\((ht%7Cf)tp(s%3F)%3A%5C%2F%5C%2F[0-9a-zA-Z]([-%5C.%5Cw]%2A[0-9a-zA-Z])%2A([%3A][0-9]+)%3F%5C%2F%3F([-a-zA-Z0-9%5C.%5C%3F%5C,%5C'%5C%2F%5C%5C%5C+=&%25%5C$#_]%2A))%7C(mailto%3A[a-zA-Z0-9%5C-_%5C.]+@[a-zA-Z0-9%5C-_%5C.]+%5C.[a-z]{2,})%7C(ssh%3A%5C%2F%5C%2F([-a-zA-Z0-9_]+([%3A][^@]%2A)%3F@)%3F[-a-zA-Z0-9_%5C.]+((%3A[0-9]{2,5})%3F(%5C%2F[-a-zA-Z0-9_]+)%3F)%3F)\
rzCommand\\
rzOptions\-e%20-v\
szCommand\\
szOptions\-e%20-v\
